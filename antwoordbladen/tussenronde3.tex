...
{\em Opmerking:} om beide punten te krijgen moet je ook proposities geven!}
}
\newpage
De meer lugubere raadsels:
\question[2]{
Een man ligt dood op het platteland met een rugzak naast hem.

Wat is er gebeurd?
\fillwithlines{\stretch{1}}
}
\question[2]{
Er rijd een zwarte auto op een zwarte baan, de gebouwen zijn zwart en de bewoners hebben hun zwarte gordijnen gesloten. Er geen enkel licht, dus de autolichten en straatverlichting staan uit. De auto stopt en laat de zwarte kat oversteken. Hoe komt het dat de autobestuurder de zwarte kat zag?
...
max. punten & 4 & 2 & 2 & 2 & 2 & 2 & 4 & 2 & 2 \\ \hline
score       &   &   &   &   &   &   &   &   &   \\ \hline
\end{tabular}
\end{table}